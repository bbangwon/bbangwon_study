...
namespace Flood_Control
{
    ...
    public class Game1 : Microsoft.Xna.Framework.Game
    {
        ...
        const float floodAcceletationPerLevel = 0.5f;
        ...
        protected override void Draw(GameTime gameTime)
        {
            ...
            if((gameState == GameStates.Playing) || (gameState == GameStates.GameOver))
            {
                ...
                {
                    spriteBatch.DrawString(pericles36Font, zoom.Text, new Vector2(this.Window.ClientBounds.Width/2, this.Window.ClientBounds.Height/2),zoom.DrawColor, 0.0f, 
                        new Vector2(pericles36Font.MeasureString(zoom.Text).X/2, pericles36Font.MeasureString(zoom.Text).Y/2),zoom.Scale,SpriteEffects.None,0.0f);
                }
        ...
        {
            spriteBatch.Draw(playingPieces, new Rectangle(pixelX, pixelY, GamePiece.PieceWidth, GamePiece.PieceHeight), gameBoard.fadingPieces[positionName].GetSourceRect(), new Color(255 * gameBoard.fadingPieces[positionName].alphaLevel, 255 * gameBoard.fadingPieces[positionName].alphaLevel, 255 * gameBoard.fadingPieces[positionName].alphaLevel, 255 * gameBoard.fadingPieces[positionName].alphaLevel));
        }
        ...
        private void StartNewLevel()
        {
            ...
            floodIncreaseAmount += floodAcceletationPerLevel;
            gameBoard.ClearBoard();
            gameBoard.GenerateNewPieces(false);
        }
