...
#endregion
#region Collsion Related Properties
        public Rectangle BoundionBoxRect
        {
...
#region Collision Detection Methods
        public bool IsBoxColliding(Rectangle OtherBox)
        {
            ...
            {
                return BoundionBoxRect.Intersects(OtherBox);
            }
            else
            {
                return false;
...
#endregion
#region Animation-Related Method
...
#region Update and Draw Methods
        ...
        public virtual void Draw(SpriteBatch spriteBetch)
        {
            if(!Expired)
            {
                if(Camera.ObjectIsVisible(WorldRectangle))
                {
                    spriteBetch.Draw(Texture, ScreenCenter, Source, tintColor, rotation, RelativeCenter, 1.0f, SpriteEffects.None, 0.0f);
                }
            }
        }
#endregion
